...
public class ReportUtils extends ReportNGUtils {
	...
	public List<String> getTestOutput(final ITestResult result) {
		...
		final Exception error = (Exception) result
				.getAttribute("reportGeneratingException");

		if (error != null) {
			output.add("Generating report error: " + error);
			return output;
		}
		List<String> attribute = (List<String>) result
				.getAttribute("screenshots");
		List<String> screenshots = attribute;
		if (!screenshots.isEmpty()) {
			for (String str : screenshots) {
				// String str1 = "<a href=\"../../" + str +
				// "\" target=\"_blank\">Screenshot</a>";
				// String str1 = "<li><img src=\"../../" + str
				// + "\" alt=\"\"+ data-large-src=\"../../" + str
				// + "\"></li>";
				String str1 = "<li><a href=\"../../" + str
						+ "\" target=\"_blank\"><img src=\"../../" + str
						+ "\" alt=\"\"></a></li>";
				output.add(str1);
			}
		}
